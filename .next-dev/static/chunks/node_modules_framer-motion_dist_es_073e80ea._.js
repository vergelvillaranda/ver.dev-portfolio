...
__turbopack_context__.s([]);
(()=>{
    const e = new Error("Cannot find module './components/AnimatePresence/PopChild.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './components/AnimatePresence/PresenceChild.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
(()=>{
    const e = new Error("Cannot find module './value/use-follow-value.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
(()=>{
    const e = new Error("Cannot find module './value/use-will-change/WillChangeMotionValue.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
(()=>{
    const e = new Error("Cannot find module './utils/use-page-in-view.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './utils/transform-viewbox-point.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './utils/transform-rotated-parent.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
 ...
 */ function MotionConfig(param) {
     ...
     */ const parentConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(MotionConfigContext);
    config = {
        ...parentConfig,
        ...config
    };
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(MotionConfigContext.Provider, {
        value: context,
        children: children
    });
}
...
function shouldForward(key, isValidProp) {
    var _isValidProp;
    return key.startsWith("on") ? !isValidMotionProp(key) : (_isValidProp = isValidProp === null || isValidProp === void 0 ? void 0 : isValidProp(key)) !== null && _isValidProp !== void 0 ? _isValidProp : !isValidMotionProp(key);
}
function filterProps(props, isDom, forwardMotionProps, isValidProp) {
    ...
    for(const key in props){
        ...
        if (shouldForward(key, isValidProp) || forwardMotionProps === true && isValidMotionProp(key) || !isDom && !isValidMotionProp(key) || props["draggable"] && key.startsWith("onDrag")) {
...
const createScopedWaapiAnimate = (scope)=>{
    function scopedAnimate(elementOrSelector, keyframes, options) {
        return new GroupAnimationWithThen((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$animation$2f$animators$2f$waapi$2f$animate$2d$elements$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["animateElements"])(elementOrSelector, keyframes, options, scope));
    }
    return scopedAnimate;
};
...
(()=>{
    const e = new Error("Cannot find module './offset-to-range.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
(()=>{
    const e = new Error("Cannot find module './utils/offset-to-range.mjs'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function attachToAnimation(animation, options) {
    ...
    const range = options.target ? offsetToViewTimelineRange(options.offset) : undefined;
    /**
...
//# sourceMappingURL=node_modules_framer-motion_dist_es_073e80ea._.js.map